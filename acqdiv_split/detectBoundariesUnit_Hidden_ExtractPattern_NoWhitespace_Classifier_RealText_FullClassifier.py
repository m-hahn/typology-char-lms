...
with open("segmentation-predictions/"+args.language+"_full-real.txt", "w") as outFileReal:
  with open("segmentation-predictions/"+args.language+"_full-predicted.txt", "w") as outFilePredicted:
