...
\usepackage[hyperref,acceptedWithA]{tacl2018v2} % use ``nohyperref'' to disable  hyperref
...
%\taclfinalcopy % For camera-ready, replace "\taclfinalfalse" with
% "\taclfinalcopy"
...
% from Michael's side, also add Urvashi Khandelwal
