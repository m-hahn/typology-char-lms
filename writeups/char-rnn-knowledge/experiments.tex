...
\begin{table}[t]
  \begin{center}
    \begin{tabular}{l|l|l|l}
      ...
      WordNLM&   \\ % when including OOVs: 81.0/83.8/81.5 & 72.9 & 77.6\\
    \end{tabular}
  \end{center}
...
The classifier based on word embeddings is by far the most successful, confirming that word embeddings encode number reliably.
