...
We reweighted stimuli from the three genders to balance the three genders, so that the random baseline accuracy is 33\%. % Marco: I added this, can you check it's clear?
...
By design, random baseline accuracy is 50\%.
