...
Results are presented in the left part of Figure~\ref{fig:german-syntax}. The word LSTM  performs best, followed by the LSTM CNLM.
...
Results are shown in the central part of Figure~\ref{fig:german-syntax}.  Again, the word LSTM has
