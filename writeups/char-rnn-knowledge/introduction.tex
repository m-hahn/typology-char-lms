...
RNN vocabulary \cite{Goldberg:2017}. This is a reasonable practical approach, but it makes
...
few months after birth \cite[e.g.,][]{Maye:etal:2002,Kuhl:2004}. We
believe that focusing on language modeling of an unsegmented phoneme
sequence, abstracting away from other complexities of a fully realistic
child language acquisition setup, is particularly instructive, in
terms of the kind of linguistic constituents that will implicitly
emerge.
...
capture various forms of linguistic knowledge that are intuitively
