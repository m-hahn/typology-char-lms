...
unigram frequency would also be at chance level.

\paragraph{Article-noun gender agreement}
%(1) eadj-aonoun:

Similar to German, Italian articles agree with the noun in gender; however, Italian has a relatively extended paradigm of masculine and feminine nouns differing only in the final vowel vowel (-\emph{o} and -\emph{a}, respectively). We construct pairs of stimuli of the form:
...
below, stimuli where checked for strong semantic anomalies. %  In
