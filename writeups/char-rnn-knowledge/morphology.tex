...
-\emph{r} or through vowel change (\emph{Umlaut}, e.g., \emph{T{\"o}chter} for singular \emph{Tochter} `daughter'). \textbf{MICHAEL: maybe better to put also exampel with -r, or at least not an Umlaut example ending in -r?}
%\textbf{Add one
