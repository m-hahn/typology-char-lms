...
number. We study German because it possesses nominal classes
...
in -\emph{r} (127 items) or Umlaut (38 items), with their respective
singulars. %\textbf{(how many?)}.
We further selected all remaining plurals ending in -\emph{n} (1467 items), -\emph{s} (98 items) and -\emph{e} (832 items) as test data.
%\textbf{Need information on the test set for the training classes.}
To control for the impact of random training sample selection, we
