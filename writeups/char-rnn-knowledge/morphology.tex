...
The diagnostic classifier was trained on 15 singulars and plurals
...
reliably when the target is a new suffixation pattern, albeit one that
is distinct from those seen in (diagnostic-classifer) training, than
