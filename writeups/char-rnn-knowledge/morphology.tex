...
Classifiers based on CNLM or autoencoder representations show below-chance accuracy on the singulars ending in characters typical of plurals (\emph{-n, -s, -e, -r}), i.e., the diagnostic classifiers mistake many singulars for plurals based on their ending.
On such singulars, CNLM-derived encodings lead to \emph{lower} accuracies than those from the autoencoder.
