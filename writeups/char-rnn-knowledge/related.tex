...
perspective, \newcite{Schuetze:2017} recently defended tokenization-free
...
decade because of their greater generality  compared to word-level models. % , and because, intuitively, they should be able to
...
methods, and is not directly relevant here, \cite[e.g.,][and references there]{Brent:Cartwright:1996,goldwater-bayesian-2009}.
...
\newcite{Elman:1990} already reported a proof-of-concept experiment on
...
patterns. %Their model is not directly comparable to ours, since it
