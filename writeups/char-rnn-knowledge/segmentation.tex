...
development partition of the Wikipedia corpus, such that half of these were the last character
...
aditional dataspoints for testing.  Both training and test sets were
