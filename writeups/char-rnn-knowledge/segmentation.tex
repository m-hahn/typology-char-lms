...
TODO how well does a classifier do on the unit?
...
With whitespace, we found units that strongly correlate with the presence of a word boundary (Pearson > 0.8 when `after reading the whitespace').

% Nice visualization for the unit?
